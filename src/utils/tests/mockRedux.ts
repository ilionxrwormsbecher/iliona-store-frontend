...
export const reduxCategoriesLoading = {
    initialState: {
        packagesSlice: {
            errorMessage: "",
            ilionaPackages: [],
...
export const reduxCategoriesError = {
    initialState: {
        packagesSlice: {
            errorMessage: "",
            ilionaPackages: [],
        ...
        packagesSlice: {
            ...
            ilionaPackages: [
                ...
                },
                {
                    ...
                    summary:
                        "Wij leggen de lat hoog voor beveiliging. Norton wordt keer op keer erkend door gerenommeerde testlaboratoria.\nGeen enkel ander consumentenmerk werd zo vaak bekroond door PC Magazine als Norton.",
                ...
                },
                {
                    ...
                    summary:
                        "Microsoft 365 is een suite met apps die je helpen verbonden te blijven en dingen gedaan te krijgen",
...
export const reduxFullStoreButNoSelectedPackage = {
    initialState: {
        packagesSlice: {
            errorMessage: "wewwewe",
            ilionaPackages: [
                {
                    imageUrl: "https://ilionaprod2001.blob.core.windows.net/app-store-logos/dockerLogoResized.png",
                    packageName: "Docker Desktop",
        ...
        router: {
            location: {
                pathname: "/details/22f3046f-2caa-4108-90e4-61377450f3fa",
                search: "",
                hash: "",
                state: null,
                key: "c79skqlb",
