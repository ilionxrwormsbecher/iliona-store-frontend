...
export const localPackagesMOCK = {
    local_packages: [
        { name: "7zip.install", version: "21.7" },
        { name: "adobereader", version: "2022.001.20085" },
        { name: "BarracudaNAC", version: "9.2.1046.0" },
        { name: "chocolatey", version: "1.0.1" },
        { name: "chocolatey-core.extension", version: "1.3.5.1" },
        { name: "chocolatey-windowsupdate.extension", version: "1.0.4" },
        { name: "ilx-csa", version: "1.0.8" },
        { name: "ILX-DellSupportAssist", version: "3.10.4.18" },
        { name: "ILX-dotnet-6.0-desktopruntime", version: "6.0.1" },
        { name: "ILX-GoogleChrome-AU", version: "98.0.4758.102" },
        { name: "ilx-office365-AU", version: "14729.20228" },
        { name: "ILX-PushClient", version: "1.2" },
        { name: "ILX-RebootHealthCheck", version: "1.1" },
        { name: "ILX-ScreenToGif", version: "2.35.3" },
        { name: "ilx-sentinel1-AU", version: "21.6.2.272" },
        { name: "ilx-storefront-agent", version: "1.0.0" },
        { name: "kaseya", version: "9.5.0.30" },
        ...
        { name: "keeper", version: "16.4.6" },
        { name: "notepadplusplus", version: "8.3.3" },
        { name: "notepadplusplus.install", version: "8.3.3" },
        { name: "vcredist140", version: "14.31.31103" },
        { name: "winscp.install", version: "5.19.6" },
        { name: "XeroxWorkplaceCloudClient", version: "1.0.0.0" },
        { name: "ILX-AdobePro", version: "1.0.0.0" },
    ],
};
