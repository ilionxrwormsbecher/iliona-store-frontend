...
import { reduxFullStoreWithoutPackages, reduxFullStoreWithPackagesAndCategories, reduxNoPackagesAndCategories, reduxPackagesErrormessage, reduxPackagesLoading } from '../utils/tests/mockRedux';
...
test('should render the category title correctly', async () => { 
    const component = setupTest(rootReducer(), reduxFullStoreWithPackagesAndCategories);
